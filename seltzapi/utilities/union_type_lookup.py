...
from seltzapi.models.content_options import (
    ContentOptions,
)
from seltzapi.models.snippet_options import (
    SnippetOptions,
)
...
class UnionTypeLookUp:
    ...
    _templates: ClassVar[dict[str, Callable]] = {
        "FieldsContent": lambda: OneOf(
            [
                LeafType(bool),
                LeafType(ContentOptions),
            ],
            Context.create(
               is_optional=True,
            ),
        ),
        "FieldsSnippets": lambda: OneOf(
            [
                LeafType(bool),
                LeafType(SnippetOptions),
            ],
            Context.create(
               is_optional=True,
            ),
        ),
        "Fields2Content": lambda: OneOf(
            [
                LeafType(bool),
                LeafType(ContentOptions),
            ],
