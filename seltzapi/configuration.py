...
from seltzapi.logging.configuration.api_logging_configuration import (
...
class Configuration(HttpClientConfiguration):
    ...
    def __init__(self, http_client_instance=None,
        ...
        self._custom_header_authentication_credentials = custom_header_authentication_credentials
